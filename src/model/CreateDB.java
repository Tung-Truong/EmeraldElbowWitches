...
public class CreateDB {
    ...
    public static void run() throws ClassNotFoundException, SQLException {
        ...
        connection.createStatement().execute("create table requestTable(employeeId VARCHAR(255), requestType VARCHAR(255), isActive VARCHAR(255), timeSubmitted VARCHAR(255), location VARCHAR(255))");
